        ...
        double[,] vectors2 =
{
        ...
        matrix3.CalculateProduct(2);
        Console.WriteLine("Произведение матрицы и скаляра: " + matrix3);

        Console.WriteLine(matrix3);
        Console.WriteLine("Определитель матрицы: " + matrix3.GetDeterminant());

        Console.WriteLine("Произведение матрицы и вектора: " + matrix3.CalculateProduct(new Vector(components4)));

        matrix3.CalculateSum(matrix3);
        Console.WriteLine("Сумма матриц: " + matrix3);

        matrix3.CalculateDifference(matrix3);
